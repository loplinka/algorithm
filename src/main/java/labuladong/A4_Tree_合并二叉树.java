...
public class A4_Tree_合并二叉树 {
    ...
    public TreeNode mergeTreesMS(TreeNode root1, TreeNode root2) {
        if (root1 == null) {
            return root2;
        }
        if (root2==null) {
        ...
        root1.left = mergeTreesMS(root1.left, root2.left);
        root1.right = mergeTreesMS(root1.right, root2.right);
